...
const CreateBlog = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Write a new post</h1>
                <p className="text-gray-500 dark:text-gray-400 mt-2">Publish your latest thoughts or tutorials to the world.</p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="title"
                            required
                            placeholder="E.g., Getting Started with React and Vite"
                    ...
                    <div className="flex justify-end gap-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="flex justify-center px-8 py-2.5 border border-transparent text-sm font-medium rounded-xl shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
